...
class AresRequestProvider
{
	 ...
	 * @throws IdentificationNumberNotFoundException
	 */
	private function xmlResponse(string $url, string $in): \SimpleXMLElement
	{
		$request = $this->requestProvider->createRequest($url);
	...
	{
		$request = $this->requestProvider->createXmlRequest(self::MULTI_IN,
